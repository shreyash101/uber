...
const WaitForCaptain = (props) => {
  return (
    <div>
        <h5 onClick={() => {
                props.setWaitForCaptain(false)
            }} 
            className='w-[94%] p-3 text-center absolute top-0 right-2'><i className="text-gray-300 ri-arrow-down-wide-line"></i>
        </h5>
        <div className='flex items-center justify-around'>
            <img className='h-12' src="https://www.uber-assets.com/image/upload/f_auto,q_auto:eco,c_fill,w_956,h_638/v1555367349/assets/d7/3d4b80-1a5f-4a8b-ac2b-bf6c0810f050/original/Final_XL.png" alt="" />
            <div className='text-right'>
              <h2 className='text-lg font-medium'>Shreyash</h2>
              <h4 className='text-xl font-semibold'>TN52BG3756</h4>
              <p className='text-sm text-gray-600'>Hyndai t20</p>
            </div>
        </div>
